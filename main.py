# Đây là một ứng dụng FastAPI hoàn chỉnh được cấu trúc thành nhiều file.
# Để chạy ứng dụng, hãy lưu các khối mã dưới đây vào các file tương ứng
# trong cùng một thư mục và làm theo hướng dẫn ở cuối.
