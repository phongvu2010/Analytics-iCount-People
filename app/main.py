"""
Module chính của ứng dụng - Điểm khởi đầu (Entrypoint).

Module này chứa hai chức năng chính:
1.  Một giao diện dòng lệnh (CLI) sử dụng Typer để chạy quy trình ETL.
2.  Một ứng dụng web API sử dụng FastAPI.
"""
import contextlib
import duckdb
import logging
